...
You'll remember from the earlier [Logistic Regression
page](https://odsti.github.io/cfd-textbook/logistic_regression.html) that the
process of fitting a single predictor logistic regression goes as follows:
...
We went through the mechanics of this on the [Logistic Regression page](https://odsti.github.io/cfd-textbook/logistic_regression.html), but just for some
